...
public interface URIConstants {
    ...
    String EXPORT_OPEN_DATA = "/export/nettest-opendata-{year}-{month}.{format}";
    ...
    String EXPORT_OPEN_DATA_HOURS = "/export/nettest-opendata_hours-{hours}.{format}";
    String EXPORT_OPEN_DATA_RECENT = "/export/nettest-opendata.{format}";
