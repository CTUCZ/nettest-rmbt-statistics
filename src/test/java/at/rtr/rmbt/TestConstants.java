...
public interface TestConstants {
    ...
    String DEFAULT_STATUS = "FINISHED";
    String DEFAULT_EXPECTED_CSV_RESPONSE_ENTITY = "<200 OK OK,open_uuid,open_test_uuid,status,time,lat,long,download_kbit,upload_kbit,ping_ms,signal_strength,lte_rsrp,platform,provider_name,model,loc_accuracy,download_classification,upload_classification,ping_classification,signal_classification9a837fab-2d65-4256-8fbf-0fd373207d37,fa39d023-6b54-4008-a67e-24f5bdb579bc,FINISHED,DEFAULT_TIME_STRING,31.3,18.0,900,36000,35.3,-94,-34,Android,DEFAULT_PROVIDER,DEFAULT_MODEL,13.7,1,3,2,88,[Content-Disposition:\"attachment;filename=opentests.csv\", Content-Type:\"text/csv;charset=UTF-8\"]>";
